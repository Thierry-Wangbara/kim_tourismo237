...
@section('title', 'Modifier ' . $site->name . ' - TOURISM237')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">
                        <i class="bi bi-pencil me-2"></i>Modifier le Site
                    </h2>
                    <p class="text-muted mb-0">{{ $site->name }}</p>
                </div>
                <div class="btn-group">
                    <a href="{{ route('sites.manager.show', $site) }}" class="btn btn-outline-primary">
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sites.manager.update', $site) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('region') is-invalid @enderror" 
                                    ...
                                    @foreach($regions as $key => $value)
                                        <option value="{{ $key }}" {{ old('region', $site->region) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      required>{{ old('description', $site->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="gallery" class="form-label">Ajouter des Images à la Galerie</label>
                            <input type="file" 
                            ...
                            @if($site->gallery && count($site->gallery) > 0)
                                <div class="mt-2">
                                    <small class="text-muted">Galerie actuelle :</small>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('opening_hours') is-invalid @enderror" 
                                      ...
                                      name="opening_hours" 
                                      rows="2" 
                                      placeholder="Ex: Lundi - Vendredi: 8h00 - 18h00">{{ old('opening_hours', $site->opening_hours) }}</textarea>
                            @error('opening_hours')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('access_info') is-invalid @enderror" 
                                      ...
                                      name="access_info" 
                                      rows="2" 
                                      placeholder="Ex: Accessible en voiture, parking disponible">{{ old('access_info', $site->access_info) }}</textarea>
                            @error('access_info')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="parking" 
                                               id="parking"
                                               {{ in_array('parking', old('features', $site->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="restaurant" 
                                               id="restaurant"
                                               {{ in_array('restaurant', old('features', $site->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="guide" 
                                               id="guide"
                                               {{ in_array('guide', old('features', $site->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="wifi" 
                                               id="wifi"
                                               {{ in_array('wifi', old('features', $site->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="toilettes" 
                                               id="toilettes"
                                               {{ in_array('toilettes', old('features', $site->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="handicap" 
                                               id="handicap"
                                               {{ in_array('handicap', old('features', $site->features ?? [])) ? 'checked' : '' }}>
